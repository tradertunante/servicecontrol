...
export default function SuperadminTemplatesPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        // 1) Plantillas globales (solo columnas necesarias)
        ...
        // 2) Áreas en batch (evita N+1 queries)
      ...
      >
        <div>
          ...
          <div style={{ opacity: 0.75, fontWeight: 900 }}>
            Packs + Plantillas (Global)
          </div>
        </div>

        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          {/* De momento dejo el botón (placeholder). Si ya tienes la ruta /superadmin/global-audits o packs, lo conecto cuando me pegues ese page.tsx */}
          <button
          ...
          <button
            onClick={() => alert("Aquí irá: crear plantilla global")}
            style={btnBlack}
          >
            + Crear plantilla
          </button>
