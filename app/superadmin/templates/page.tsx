...
export default function SuperadminGlobalTemplateBuilderPage() {
  ...
  // ✅ OJO: esto exige que la carpeta sea [templateId]
                ...
                <tr key={r.questionId} style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                  <td style={{ padding: "10px 8px", verticalAlign: "top" }}>
                    <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                      <button onClick={() => move(r.questionId, "up")} disabled={saving} style={{ width: 34, height: 34, borderRadius: 10, border: "1px solid rgba(0,0,0,0.2)", background: "#fff", fontWeight: 950 }}>
                        ↑
                      </button>
                      <button onClick={() => move(r.questionId, "down")} disabled={saving} style={{ width: 34, height: 34, borderRadius: 10, border: "1px solid rgba(0,0,0,0.2)", background: "#fff", fontWeight: 950 }}>
                        ↓
                      </button>
                    </div>
                  ...
                  <td style={{ padding: "10px 8px", verticalAlign: "top" }}>
                    <input
                      value={r.tag}
                      onChange={(e) => setRows((prev) => prev.map((x) => (x.questionId === r.questionId ? { ...x, tag: e.target.value } : x)))}
                      onBlur={() => updateQuestion(r.questionId, { tag: r.tag.trim() || null })}
                      style={{ width: "100%", padding: "10px 12px", borderRadius: 14, border: "1px solid rgba(0,0,0,0.18)", outline: "none", fontWeight: 900, background: "#fff" }}
                    />
                  </td>
                  ...
                  <td style={{ padding: "10px 8px", verticalAlign: "top" }}>
                    <textarea
                      value={r.standard}
                      onChange={(e) => setRows((prev) => prev.map((x) => (x.questionId === r.questionId ? { ...x, standard: e.target.value } : x)))}
                      onBlur={() => updateQuestion(r.questionId, { text: r.standard.trim() })}
                      style={{ width: "100%", minHeight: 64, padding: "10px 12px", borderRadius: 14, border: "1px solid rgba(0,0,0,0.18)", outline: "none", fontWeight: 900, resize: "vertical", background: "#fff" }}
                    />
                  </td>
                  ...
                  <td style={{ padding: "10px 8px", verticalAlign: "top" }}>
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setRows((prev) => prev.map((x) => (x.questionId === r.questionId ? { ...x, comment_requirement: v } : x)));
                  ...
                  <td style={{ padding: "10px 8px", verticalAlign: "top" }}>
                    <select
                      ...
                      onChange={(e) => {
                        const v = e.target.value as RequirementType;
                        setRows((prev) => prev.map((x) => (x.questionId === r.questionId ? { ...x, photo_requirement: v } : x)));
                  ...
                  <td style={{ padding: "10px 8px", verticalAlign: "top" }}>
                    <select
                      ...
                      onChange={(e) => {
                        const v = e.target.value as RequirementType;
                        setRows((prev) => prev.map((x) => (x.questionId === r.questionId ? { ...x, signature_requirement: v } : x)));
                  ...
                  <td style={{ padding: "10px 8px", verticalAlign: "top", textAlign: "center" }}>
                    <button onClick={() => deleteQuestion(r.questionId)} disabled={saving} style={{ width: 42, height: 42, borderRadius: 12, border: "1px solid rgba(0,0,0,0.2)", background: "#fff", fontWeight: 950 }}>
                      🗑️
                    </button>
                  </td>
                </tr>
