-- Make rpc_team_summary template_progress use raw team production by template
-- Purpose:
-- allow the center panel "Objetivos por rubro" to show real executions vs target
-- (for example 21 / 10) instead of capping completed work at target.
