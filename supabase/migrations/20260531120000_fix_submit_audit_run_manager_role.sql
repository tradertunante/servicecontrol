-- Fix: submit_audit_run excluded 'manager' and 'general_manager' from allowed roles.
-- The FORBIDDEN_ROLE check must match canSubmitAudit() in lib/auth/permissions.tsx.
