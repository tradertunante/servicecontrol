-- ============================================================================
-- Texto de pregunta bilingüe (STANDARD en español + inglés)
-- ============================================================================
-- `audit_questions.text` sigue siendo el texto por defecto (español). Se
-- añade `text_en` opcional; cuando existe, el auditor lo ve en vez de `text`
-- si tiene el idioma de interfaz (cookie sc-locale / useLocale()) en inglés.
-- Sin `text_en`, se sigue mostrando `text` sin cambios (retrocompatible).
-- ============================================================================

alter table public.audit_questions
  add column if not exists text_en text;

-- get_audit_run_full: exponer text_en junto a text para que el cliente
-- (que sí conoce el locale del usuario) elija cuál mostrar.
