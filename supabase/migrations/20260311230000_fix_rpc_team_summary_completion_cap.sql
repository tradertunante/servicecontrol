-- Fix rpc_team_summary target math consistency
-- Purpose:
-- keep completed/remaining/progress aligned by capping completed work at target_count.
-- This prevents impossible states such as progress > 100% while remaining work still exists.
