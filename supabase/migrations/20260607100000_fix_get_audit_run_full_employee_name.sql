-- Fix: include employee_name in get_audit_run_full run payload.
-- employee_name was missing from the SELECT and jsonb_build_object,
-- so reopening an audit always showed an empty name field.
